...
public:
    ...
    vec3(double _s){data_[0]=data_[1]=data_[2]=_s;}
...
/// reflect vector \c v at normal \c n. Vector \c v is pointing toward the origin of \c n,
/// while the returned reflected vector is pointing from the origin of \c n.
